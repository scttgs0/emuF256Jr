...
namespace FoenixCore.Processor.mc6809
{
    public class OpCode
    {
        ...
        public Register<ushort> ActionRegisterUS = null;
        ...
        public OpCode(byte Value, string Mnemonic, int Length8Bit, Register<ushort> ActionRegister, AddressModes Mode, ExecuteDelegate newDelegate)
        {
            this.Value = Value;
            this.Length8Bit = Length8Bit;
            this.ActionRegisterUS = ActionRegister;
            this.Mnemonic = Mnemonic;
            AddressMode = Mode;
            ExecuteOp += newDelegate;
