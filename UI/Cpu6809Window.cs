...
{
    class Cpu6809Window : Window
    {
        public static Cpu6809Window Instance = null;
...
#pragma warning disable CS0649  // never assigned
        ...
        [GUI] Cpu6809RegisterDisplayControl ucRegisterDisplay;
#pragma warning restore CS0649

        public Cpu6809Window() : this(new Builder("Cpu6809Window.ui"))
        {
        ...
        private Cpu6809Window(Builder builder) : base(builder.GetRawOwnedObject("Cpu6809Window"))
        {
...
//
        ...
        public void ExecuteStep()
        {
            ...
            if (!_kernel.CoreCpu.ExecuteNext())
            {
                   ...
                   )
                {
                    ...
                    if (_kernel.CoreCpu.Pins.InterruptPinActive && !_kernel.CoreCpu.Flags.Irq)
                    {
        ...
        private void on_Cpu6809Window_map(object sender, EventArgs e)
        {
            traceTimer = new()
            {
               Interval = 1000,
        ...
        private void on_Cpu6809Window_unmap(object sender, EventArgs e)
        {
            if (traceTimer != null)
            {
               traceTimer.Stop();
        ...
        private void on_Cpu6809Window_key_release_event(object sender, KeyReleaseEventArgs e)
        {
            switch (e.Event.Key)
            {
                case Gdk.Key.F5:
